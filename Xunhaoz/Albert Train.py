...
def get_model(model_name='albert-base-v2', hidden_dim=256, output_dim=5, dropout_rate=0.2):
    model_name = model_name

    tokenizer = AlbertTokenizer.from_pretrained(model_name)
    XLNet_model = AlbertModel.from_pretrained(model_name)
...
if __name__ == "__main__":
    ...
    for epoch in range(EPOCH):
        ...
        torch.save(classifier, f"Albert Model/epoch {epoch}.pt")
